...
async function downloadUpx(): Promise<string> {
    ...
    if (os.type() == "Linux") {
        await download('https://github.com/upx/upx/releases/download/v3.96/upx-3.96-amd64_linux.tar.xz', tmpdir, {
        ...
        await download('https://github.com/upx/upx/releases/download/v3.96/upx-3.96-win64.zip', tmpdir, {
            extract: true
        });
